...
|---|---|---|
| 2026-09-14 | External API/MCP **`getPortalLink`** (`POST /customers/{id}/portal-link` · scope `links:write` · rotate) + intent `portal.link` — AI/n8n ขอลิงก์หน้าลูกค้าส่ง LINE ได้ · MCP tools 28 | _pending_ |
