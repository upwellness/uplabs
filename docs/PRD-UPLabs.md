...
|---|---|---|
| 2026-09-14 | `/v2/bca` (โค้ช) เพิ่มการ์ด **"แปลผลด้วยภาพ"** ใต้ผลล่าสุด — ภาพ % ไขมัน / ไม้บรรทัดกล้ามเนื้อแยกเพศ / โมเดลไขมันช่องท้อง+แกลเลอรี ชุดเดียวกับหน้าลูกค้า · ย้าย art ไป `components/bca/BcaArt.tsx` ใช้ร่วม 2 หน้า | __HASH__ |
