...
|---|---|---|
| 2026-09-14 | BCA Reveal: การ์ด % ไขมัน + ไขมันช่องท้อง เปลี่ยนจาก SVG เป็น**ภาพจริง**พร้อมตำแหน่งลูกค้า — fat% แยกเพศ 6 ภาพ (ชาย 3–40% · หญิง 10–40%) ลูกศร+เส้นชี้ค่าจริง interpolate ระหว่างจุดที่วัดจากภาพ · visceral โมเดลช่องท้อง ระดับ 1→11 map ซ้าย→ขวา dim รอบ ๆ เหลือแถบสว่างที่ตำแหน่งลูกค้า · เกินขอบภาพบอกตรง ๆ · `app/r/bca/[token]/_art.tsx` + `public/bca/*.webp` (≤80 KB) | __HASH__ |
