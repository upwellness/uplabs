...
import { NutriScanClient } from "./NutriScanClient";

export const dynamic = "force-dynamic";

export default async function NutriScanPage() {
    ...
    <main className="min-h-screen bg-surface">
      ...
      <div className="mx-auto max-w-content px-6 py-10">
        ...
        <p className="mt-2 max-w-2xl font-thai text-sm text-ink-60">
          ถ่ายรูปอาหาร · AI วิเคราะห์ macros · glucose impact · health score · พร้อมแนะนำ Nutrilite SKU
          ที่เหมาะกับมื้อนี้
        </p>
