...
export const APPS: AppMeta[] = [
  ...
  { slug: "plate-planner",name: "Plate Planner by Dr. Gabrielle Lyon", description: "วางแผนมื้อ Muscle-Centric (Forever Strong) · 3 เป้าหมายคำนวณแยก (ลด/longevity/กล้าม) · อาหารไทยไม่ซ้ำ + รูปจาน portion จริง", icon: "🍽️", audience: "business", href: "/plate-planner", status: "live", allowedRoles: ["abo", "admin"] },
  { slug: "line-bot",     name: "LINE Bot (น้องจาน)", description: "ผูก LINE group ↔ ลูกค้า · ตั้งแผน/วิตามิน · บอทส่งเมนูรายวัน", icon: "🍽️", audience: "business", href: "/line-bot", status: "beta", allowedRoles: ["abo", "admin"] },
